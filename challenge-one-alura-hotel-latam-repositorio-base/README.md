...
Esta aplicación se ha desarrollado como una plataforma de gestión de reservas, ofreciendo a los usuarios las siguientes funcionalidades:

- **Inicio de Sesión:** Los usuarios pueden iniciar sesión con sus credenciales.
- **Reserva:** Permite a los usuarios realizar una reserva.
- **Búsqueda de Reserva:** Los usuarios pueden buscar una reserva utilizando el número de reserva y ver los datos de la persona que hizo la reserva.
- **Edición de Reserva:** Ofrece la opción de editar una reserva existente.
- **Cancelación de Reserva:** Permite a los usuarios cancelar una reserva previamente realizada.

La aplicación ha sido diseñada para proporcionar una experiencia sencilla y eficiente en la gestión de reservas, mejorando la organización y la accesibilidad para los usuarios.
