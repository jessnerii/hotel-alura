...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) throws SQLException {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (txtFechaN.getDate() != null && txtNombre.getText() != null) {
		            try {
						guardarHuespes();
	...
	protected void guardarHuespes() throws ParseException {
	    ...
	    if (txtFechaN.getDate() != null &&
	        ...
	        java.util.Date fechaN = txtFechaN.getDate();
	        java.sql.Date fechaSql = new java.sql.Date(fechaN.getTime());
	        String nreserva = txtNreserva.getText();
	        Huespes huespes = new Huespes(txtNombre.getText(), txtApellido.getText(), fechaSql,
	                txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), nreserva);
	        huespesController.guardar(huespes);
